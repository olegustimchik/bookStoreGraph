...
export abstract class BaseRepository<T extends ObjectLiteral> {
  protected readonly logger = new Logger('Base Repository');
  ...
  async create(
    ...
    return await service.findOneOrFail({ where: { id: insert.identifiers[0].id } });
  }
  ...
  private async updateQueryBuilder<Entity extends ObjectLiteral>(
    entity: DeepPartial<T>,
